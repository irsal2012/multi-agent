...
Generated based on requirements: {'agent': 'Requirement Analyst', 'input_processed': True, 'validation': {'is_valid': True, 'warnings': [], 'suggestions': ["Try to be more specific than terms like 'good', 'fast', 'easy' - provide measurable criteria"]}, 'context': {}, 'agent_instance': 'requirement_analyst', 'requirements_structure': {'functional_requirements': [], 'non_functional_requirements': [], 'constraints': [], 'assumptions': [], 'edge_cases': [], 'questions': [], 'acceptance_criteria': []}}
"""
...
class CustomUtility:
    ...
    def __init__(self):
        ...
        self.requirements = """{'agent': 'Requirement Analyst', 'input_processed': True, 'validation': {'is_valid': True, 'warnings': [], 'suggestions': ["Try to be more specific than terms like 'good', 'fast', 'easy' - provide measurable criteria"]}, 'context': {}, 'agent_instance': 'requirement_analyst', 'requirements_structure': {'functional_requirements': [], 'non_functional_requirements': [], 'constraints': [], 'assumptions': [], 'edge_cases': [], 'questions': [], 'acceptance_criteria': []}}"""
